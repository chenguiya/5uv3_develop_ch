...
0
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_common.htm', 1443082628, '6', './data/template/4_6_common_header_plugin_fansclub.tpl.php', './template/usportstyle', 'common/header_plugin_fansclub')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_qmenu.htm', 1443082628, '6', './data/template/4_6_common_header_plugin_fansclub.tpl.php', './template/usportstyle', 'common/header_plugin_fansclub')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/usportstyle/common/pubsearchform.htm', 1443082628, '6', './data/template/4_6_common_header_plugin_fansclub.tpl.php', './template/usportstyle', 'common/header_plugin_fansclub')
;?>
