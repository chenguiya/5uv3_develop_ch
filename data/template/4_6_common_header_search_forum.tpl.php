...
0
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_common.htm', 1443089916, '6', './data/template/4_6_common_header_search_forum.tpl.php', './template/usportstyle', 'common/header_search_forum')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_qmenu.htm', 1443089916, '6', './data/template/4_6_common_header_search_forum.tpl.php', './template/usportstyle', 'common/header_search_forum')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/usportstyle/common/pubsearchform.htm', 1443089916, '6', './data/template/4_6_common_header_search_forum.tpl.php', './template/usportstyle', 'common/header_search_forum')
;?>
