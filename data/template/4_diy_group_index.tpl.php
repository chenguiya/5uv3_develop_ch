<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('index');?><?php include template('common/sub_common_header'); ?><div id="pt" class="bread cl">
<div class="z">
<a href="./" title="首页"><?php echo $_G['setting']['bbname'];?></a>&nbsp;&gt;&nbsp;<a href="group.php"><?php echo $_G['setting']['navs']['3']['navname'];?></a><?php echo $navigation;?>
</div>
