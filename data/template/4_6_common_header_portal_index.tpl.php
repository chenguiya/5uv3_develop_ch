...
0
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_common.htm', 1443002010, '6', './data/template/4_6_common_header_portal_index.tpl.php', './template/usportstyle', 'common/header_portal_index')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_qmenu.htm', 1443002010, '6', './data/template/4_6_common_header_portal_index.tpl.php', './template/usportstyle', 'common/header_portal_index')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/usportstyle/common/pubsearchform.htm', 1443002010, '6', './data/template/4_6_common_header_portal_index.tpl.php', './template/usportstyle', 'common/header_portal_index')
;?>
