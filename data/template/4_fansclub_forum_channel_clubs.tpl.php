<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('channel_clubs');
0
|| checktplrefresh('./source/plugin/fansclub/template/forum/channel_clubs.htm', './template/usportstyle/common/header.htm', 1443082663, 'fansclub', './data/template/4_fansclub_forum_channel_clubs.tpl.php', './source/plugin/fansclub/template', 'forum/channel_clubs')
|| checktplrefresh('./source/plugin/fansclub/template/forum/channel_clubs.htm', './template/usportstyle/common/footer.htm', 1443082663, 'fansclub', './data/template/4_fansclub_forum_channel_clubs.tpl.php', './source/plugin/fansclub/template', 'forum/channel_clubs')
|| checktplrefresh('./source/plugin/fansclub/template/forum/channel_clubs.htm', './template/default/common/header_common.htm', 1443082663, 'fansclub', './data/template/4_fansclub_forum_channel_clubs.tpl.php', './source/plugin/fansclub/template', 'forum/channel_clubs')
|| checktplrefresh('./source/plugin/fansclub/template/forum/channel_clubs.htm', './template/default/common/header_qmenu.htm', 1443082663, 'fansclub', './data/template/4_fansclub_forum_channel_clubs.tpl.php', './source/plugin/fansclub/template', 'forum/channel_clubs')
|| checktplrefresh('./source/plugin/fansclub/template/forum/channel_clubs.htm', './template/usportstyle/common/pubsearchform.htm', 1443082663, 'fansclub', './data/template/4_fansclub_forum_channel_clubs.tpl.php', './source/plugin/fansclub/template', 'forum/channel_clubs')
;?>
...
<div id="wp" class="wp"><?php include template('extend/desktop/channel_common_header'); ?><link href="template/usportstyle/common/main.css" rel="stylesheet" />
...
<span class="fr sort">
<a href="plugin.php?id=fansclub:forumfansclub&amp;fid=<?php echo $_G['forum']['fid'];?>&amp;ac=contribute"
<?php if($_GET['ac']=='contribute' || empty($_GET['ac'])) { ?>class="active"<?php } ?>>按贡献值</a>
<a href="plugin.php?id=fansclub:forumfansclub&amp;fid=<?php echo $_G['forum']['fid'];?>&amp;ac=membernum" 
<?php if($_GET['ac']=='membernum') { ?>class="active"<?php } ?>>按粉丝数</a>
<a href="plugin.php?id=fansclub:forumfansclub&amp;fid=<?php echo $_G['forum']['fid'];?>&amp;ac=level"
<?php if($_GET['ac']=='level') { ?>class="active"<?php } ?> >按认证等级</a>
<a href="javascript:void(0);"  class="adressIco <?php if($_GET['ac']=='address') { ?>active<?php } ?>" id="adressflag">按地区</a>
</span>
</div>
            
            <div class="adressMain" id="adress" >
            	<dl>
                	<dt>地区/省：</dt><?php if(is_array($province)) foreach($province as $v) { ?>                    <dd><a href="javascript:void(0);" onclick="getcity(<?php echo $v['id'];?>);"><?php echo $v['name'];?></a></dd>
                    <?php } ?>
                </dl>
            ...
            <div class="fanWillList column-3"><?php if(is_array($arr)) foreach($arr as $v) { ?><div class="fansListaWrap">
<div class="fansLista">
<div class="fansListImg">
<a href="fans/topic/<?php echo $v['fid'];?>/" target="_blank" title="<?php echo $v['name'];?>">
<img src="<?php echo $v['icon'];?>" width="60" height="60" alt="<?php echo $v['name'];?>" title="<?php echo $v['name'];?>">
<?php if($v['specialclub']) { ?><img src="<?php echo $_G['style']['tpldir'];?>/common/images/icoa.png" class="icoA"/>
<?php } ?></a>
<span><?php echo $v['province_city'];?></span>
</div>
<div class="fansListR">
<div class="fansWillListT">
<a href="fans/topic/<?php echo $v['fid'];?>/" target="_blank" title="<?php echo $v['name'];?>"<?php if($v['specialclub']) { ?> class="colorRed"<?php } ?>><?php echo str_intercept($v['name'], 0, 8);?></a>
<a href="plugin.php?id=fansclub&amp;ac=verify&amp;type=boots&amp;fid=<?php echo $v['fid'];?>" class="badget"><?php echo $v['level_img'];?></a></div>
<div class="fansListInfo"><span class="numIco"><?php echo $v['members'];?></span><span class="plIco"><?php echo $v['posts'];?></span><span class="valueIco"><font>贡献值：</font><?php echo $v['contribution'];?></span></div>
<div>简介：<?php echo str_intercept($v['description'], 0, 13);?></div>
</div>
<div class="clear"></div>
</div>
</div>
<?php } ?>
            ...
            <div class="page"><?php echo $str_page;?></div>
        </div>
...
url:"plugin.php",
dataType:'json',
data:'id=fansclub:forumfansclub&fid=<?php echo $_G['fid'];?>&ac=ajax&proid='+id,
success:function(data){
var str='<dt>地区/市：</dt>';
jq.each(data,function(i,n){
 	str+=' <dd><a href="plugin.php?id=fansclub:forumfansclub&amp;fid=<?php echo $_G['fid'];?>&amp;ac=address&amp;cityid='+n.id+'");">'+n.name+'</a></dd>';
});
jq("#city").html(str);
jq("#city").show();
}
