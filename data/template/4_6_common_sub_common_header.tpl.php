...
0
|| checktplrefresh('./template/usportstyle/common/sub_common_header.htm', './template/default/common/header_common.htm', 1443168709, '6', './data/template/4_6_common_sub_common_header.tpl.php', './template/usportstyle', 'common/sub_common_header')
|| checktplrefresh('./template/usportstyle/common/sub_common_header.htm', './template/default/common/header_qmenu.htm', 1443168709, '6', './data/template/4_6_common_sub_common_header.tpl.php', './template/usportstyle', 'common/sub_common_header')
|| checktplrefresh('./template/usportstyle/common/sub_common_header.htm', './template/usportstyle/common/pubsearchform.htm', 1443168709, '6', './data/template/4_6_common_sub_common_header.tpl.php', './template/usportstyle', 'common/sub_common_header')
;?>
...
<?php if($_GET['diy'] == 'yes' && check_diy_perm($topic)) { include template('common/header_diy'); } if(check_diy_perm($topic)) { include template('common/header_diynav'); } if(CURMODULE == 'topic' && $topic && empty($topic['useheader']) && check_diy_perm($topic) && $_G['adminid']) { ?>
<div id="toptb" class="cl">	
     <div class="wp">
          <div class="y"><?php echo $diynav;?></div>
 </div>
</div>
...
<?php } if($_G['adminid'] ) { if(empty($topic) || ($topic['usefooter'])) { ?>
<div id="toptb" class="cl">
...
<!--<span class="chuser cl"><a href="" class="chupic"></a><a href="" class="chnews"></a><a href="" class="chpers"></a></span>-->

<ul class="chnav cl"><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="a" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>
</ul>
