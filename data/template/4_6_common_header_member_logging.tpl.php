...
0
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_common.htm', 1443082734, '6', './data/template/4_6_common_header_member_logging.tpl.php', './template/usportstyle', 'common/header_member_logging')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/default/common/header_qmenu.htm', 1443082734, '6', './data/template/4_6_common_header_member_logging.tpl.php', './template/usportstyle', 'common/header_member_logging')
|| checktplrefresh('./template/usportstyle/common/header.htm', './template/usportstyle/common/pubsearchform.htm', 1443082734, '6', './data/template/4_6_common_header_member_logging.tpl.php', './template/usportstyle', 'common/header_member_logging')
;?>
