...
class mobileplugin_hfilterad_killer{
...
class mobileplugin_hfilterad_killer_forum extends mobileplugin_hfilterad_killer {
    ...
    function post_hfilterad_dx002(){
        ...
        try
        {
            ...
            foreach ($this->killer['field'] as $v)
            {
                ...
                if(strlen($val) == mb_strlen($val, $charset))  // µ¥×Ö½Ú
                {
                    showmessage($message);
                }
