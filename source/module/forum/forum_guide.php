...
if($view != 'index') {
	...
	if(empty($data['my']['multi'])) {
        ...
        // zhangjh 2015-06-25 伪静态分页 guide/newthread/2.html
        $multipage = fansclub_multi($data[$view]['threadcount'], $perpage, $_G['page'], 'guide/'.$view.'/');
	} else {
...
$navigation = $view != 'index' ? ' <em>&rsaquo;</em> <a href="guide/'.$view.'/">'.$lang['guide_'.$view].'</a>' : '';
