...
if(!submitcheck('editsubmit')) {
	...
	// 2015-07-03 zhangjh SEO要求修改帖子返回URL
	if($isfirstpost) // 如果是第一贴
	{
		$modpost->param('redirecturl', "thread-$_G[tid].html");
	}
	elseif(intval($_GET[page]) > 1) // 如果是第二页
	{
		$modpost->param('redirecturl', "thread-$_G[tid]-$_GET[page].html#pid$pid");
	}
