...
var popup = {
	...
	open : function(pop, type, url) {
		...
		popupobj.css({'display':'block','position':'fixed','left':left,'top':top,'z-index':'10002','opacity':1});
...
var formdialog = {
	init : function() {
		$(document).on('click', '.formdialog', function() {
            ...
            $.ajax({
				type:'POST',
				url:formobj.attr('action') + '&handlekey='+ formobj.attr('id') + '&objkey=' + obj.attr('id') + '&inajax=1',
