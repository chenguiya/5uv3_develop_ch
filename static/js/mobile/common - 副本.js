	...
	open : function(pop, type, url) {
		...
		if(typeof pop == 'string') {
			...
			if(type == 'alert') {
				...
				pop = '<div class="tip"><dt>'+ pop +'</dt><dd><input class="redirect button2" type="button" value="确定" href="'+ url +'"><a href="javascript:;" class="butt_close" onclick="popup.close();">取消</a></dd></div>'
			}
		...
		popupobj.css({'display':'block','position':'fixed','left':left,'top':top,'z-index':'1000','opacity':1});
		$('#mask').css({'display':'block','width':'100%','height':'100%','position':'fixed','top':'0','left':'0','background':'rgba(0,0,0,.7)','z-index':'999'});
