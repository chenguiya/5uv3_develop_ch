...
// 2015-09-23 add by zhangjh 
function uc_get_uid_by_openid($openid)
{
    return call_user_func(UC_API_FUNC, 'user', 'get_uid_by_openid', array('openid' => $openid));
}

// 2015-09-23 add by zhangjh 
function uc_get_member_by_email($email)
{
    return call_user_func(UC_API_FUNC, 'user', 'get_member_by_email', array('email' => $email));
}

function uc_renameuser($uid, $username, $newusername)
{
