...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = '192.168.2.12';
$_config['db']['1']['dbuser'] = 'tester';
$_config['db']['1']['dbpw'] = 'DBtester8932';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'new5uv3';
$_config['db']['1']['tablepre'] = 'group_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

$_config['db']['1']['dbhost'] = '192.168.2.12';
$_config['db']['1']['dbuser'] = 'v3dba';
$_config['db']['1']['dbpw'] = 'W8Ri9ZGvW';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'new5uv3';
$_config['db']['1']['tablepre'] = 'group_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'gD3L_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '2927c01ctQ9sNqvB';
...
// -------------------  THE END  -------------------- //
$_config['playerdata']['domian'] = 'http://api.5usport.com';
$_config['static']="http://5uv3static.chenhua.cc";
