...
function credit_payurl($price, &$orderid, $bank = 'DEFAULT', $prefix = '') {
	global $_G;

    // zhangjh 2015-09-14 加订单前缀
...
function invite_payurl($amount, $price, &$orderid, $bank = 'DEFAULT', $prefix = '') {
	global $_G;
 
    // $orderid = dgmdate(TIMESTAMP, 'YmdHis').random(18);
    $orderid = $prefix.dgmdate(TIMESTAMP, 'YmdHis').random(18 - strlen($prefix)); // zhangjh 2015-09-14 加订单前缀
